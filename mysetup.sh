...
sleep 3s
#cd /lustrehome/lgeneros/mucoll-studies/
#unset MARLIN_DLL
export MarlinTrk_DIR="/opt/ilcsoft/muonc/MarlinTrk/v02-09-01/"
echo 'export MarlinTrk_DIR'
